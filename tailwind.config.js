...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Dark-mode-first palette with neon accents
        slate: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
        ...
        background: {
          DEFAULT: '#0a0a0a', // Deep black for dark mode
          light: '#ffffff',   // Pure white for light mode
          card: '#1a1a1a',    // Card background dark
          'card-light': '#f8f9fa', // Card background light
        },
        foreground: {
          DEFAULT: '#ffffff', // White text for dark mode
          light: '#0a0a0a',   // Black text for light mode
          muted: '#a1a1aa',   // Muted text dark
          'muted-light': '#71717a', // Muted text light
        },
        primary: {
        ...
        // Utility colors
        border: {
          DEFAULT: '#262626', // Dark border
          light: '#e5e7eb',   // Light border
        },
        card: {
          DEFAULT: '#1a1a1a', // Dark card
          light: '#ffffff',   // Light card
        },
        muted: {
          DEFAULT: '#171717', // Dark muted background
          light: '#f1f5f9',   // Light muted background
          foreground: '#a1a1aa', // Muted text
          'foreground-light': '#64748b', // Light muted text
        },
      },
      fontFamily: {
        sans: [
